-- =====================================================
-- Migration 022: Add currency to option_holdings view
-- =====================================================
-- Adds currency from the opening transaction (BTO/STO) to option holdings
...
-- Notes and currency from first opening transaction (BTO for long, STO for short)
opening_notes AS (
...
SELECT
    ...
    -- Notes and currency from opening transaction
    onn.notes,
...
COMMENT ON VIEW option_holdings IS 'Vypočítané aktuální opční pozice s Greeks, moneyness, buffer, notes a currency z otevírací transakce';
